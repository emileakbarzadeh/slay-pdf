...
const sections = [
  ...
  },
  {
    ...
    paths: ['/merge-pdf-without-uploading.html', '/split-pdf-without-uploading.html', '/sign-pdf-without-uploading.html', '/redact-pdf-without-uploading.html', '/compress-pdf-without-uploading.html', '/rotate-pdf-without-uploading.html', '/crop-pdf-without-uploading.html', '/password-protect-pdf-without-uploading.html'],
  },
  {
