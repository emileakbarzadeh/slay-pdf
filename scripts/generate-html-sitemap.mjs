...
const sections = [
  {
    ...
    paths: ['/', '/free-pdf-editor.html', '/tools.html', '/search.html', '/sitemap.html', '/link-to-slay-pdf.html', '/faq.html', '/privacy.html', '/pdf-privacy-security.html', '/pdf-privacy-checklist.html'],
  },
  {
    title: 'Guides',
